    ...
    <>
      ...
      <div className="min-h-screen bg-gray-100 text-gray-900">
        ...
        <section className="p-8 max-w-4xl mx-auto">
          ...
          <form className="grid gap-4" onSubmit={e => { e.preventDefault(); alert('Message sent! (Demo)'); }}>
            <label htmlFor="name" className="sr-only">Name</label>
            <input id="name" type="text" placeholder="Name" className="p-2 border rounded" required />
            <label htmlFor="email" className="sr-only">Email</label>
            <input id="email" type="email" placeholder="Email" className="p-2 border rounded" required />
            <label htmlFor="message" className="sr-only">Message</label>
            <textarea id="message" placeholder="Message" className="p-2 border rounded" rows="4" required></textarea>
